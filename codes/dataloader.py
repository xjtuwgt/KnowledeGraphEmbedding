...
class BiTrainDataset(Dataset):
    def __init__(self, triples, nentity, nrelation, mode):
        ...
        self.true_head, self.true_tail = self.get_true_head_and_tail(self.triples, nentity, nrelation)
    ...
    def __getitem__(self, idx):
        ...
        labels = np.concatenate((bi_labels, r_bi_labels), axis=0).reshape(2, self.nentity)
        ...
        positive_sample = torch.LongTensor([positive_sample, r_positive_sample])
    ...
    def get_true_head_and_tail(triples, nentity, nrelation):
        ...
        for relation, tail in true_head:
            ...
            true_head[(relation, tail)] = binary_labels(list(set(true_head[(relation, tail)])))
