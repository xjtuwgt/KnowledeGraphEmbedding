...
from codes.kgemodel import KGEModel
from codes.dataloader import BiTrainDataset, BidirectionalOneShotIterator
from kgembedUtils.utils import set_seeds
from torch.optim import Adam
from torch.optim.lr_scheduler import CosineAnnealingLR
from kgembedUtils.optimization import AdamW, WarmupCosineSchedule
...
def parse_args(args=None):
    ...
    parser.add_argument('--loss_type', type=int, default=1, help="0: onevsall, 1: kvsall")
    ...
    # +++++++++++++++++
    parser.add_argument('--conv_embed_shape1', type=int, default=16, help='The first dimension of the reshaped 2D embedding. '
                                                                          'The second dimension is infered. Default: 20')
    parser.add_argument('--conv_channels', type=int, default=64, help='number of filters')
...
def train_dag_kge_model(args, train_graph, nentity, nrelation, ntriples, all_true_triples, train_triples, valid_triples, test_triples):
    ...
    if args.do_train:
        ...
        for step in range(init_step, args.max_steps):
            log = kge_model.train_step(kge_model, graph, optimizer_graph, train_iterator, args)
