...
def HypeParameterSpace(model_name):
    ...
    #++++++++++++++++++++++++++++++++++
    search_space = [learning_rate, adam_weight_decay, loss_type, att_drop, feat_drop, input_drop, ent_embed_dim, rel_embed_dim,
                    conv_embed_shape1, conv_channels, topk_type, feed_forward, edge_drop, zero_on,
                       max_steps, top_k, hops, layers, num_heads, alpha, negative_on, hidden_dim, embed_dim, smooth_factor, model_name, conv_filter_size,
...
if __name__ == '__main__':
    generate_random_search_bash(model_name='Tucker', data_name='FB15k-237', task_num=40)